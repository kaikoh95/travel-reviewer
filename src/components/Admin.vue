<template>
  <div style="margin-top: 10px">
    <h1 align="center"><span>My Venues</span></h1>
    <br>
    <div style="text-align: center">
      <Button type="primary" onclick="window.location.href='/venues'">All Venues</Button>
      <Button type="secondary" @click="modalFilter= true" style="margin-left: 10px">Search</Button>
      <Button type="success" @click="mainReset()" style="margin-left: 10px">Reset</Button>
    </div>
    ...
    <Footer class="layout-footer">
      <Button align="center" style="margin-right: 30px; text-align: center" type="default" onclick="window.location.href='/venues'">All Venues</Button>
  ...
  export default {
    ...
    methods: {
      getVenues: function() {
        ...
        let venuesUrl =
          'http://localhost:4941/api/v1/venues/?'+ 'adminId=' +this.$cookies.get("UserId") + '&' +
